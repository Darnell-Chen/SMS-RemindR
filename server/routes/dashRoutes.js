...
router.get("/getData", authenticateToken, (req, res) => {
    ...
    // we'll attach a new jwt access token that will have another 30 minutes of access
    const newToken = jwt.sign(req.user, process.env.JWT_SECRET_KEY, {expiresIn: 60 * 30});
