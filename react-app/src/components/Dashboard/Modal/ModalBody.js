    ...
    return(
        ...
        <div className="modal-body">
            ...
            <div className="msgType">
                <div>
                    <input type="radio" name="contactType needBorder" value="phone" onClick={() => {changeContactType("phone")}} required/>
                    <label> &nbsp; Phone</label>
                </div>

                <div>
                    <input type="radio" name="contactType needBorder" value="email" onClick={() => {changeContactType("email")}} required/>
                    <label> &nbsp; Email</label>
                </div>

                <div>
                    <input type="radio" name="contactType needBorder" value="discord" onClick={() => {changeContactType("discord")}} required/>
                    <label> &nbsp;Discord</label>
                </div>
            </div>

            {(contactType === "phone") ? <input className="needBorder" name="phone" placeholder="Phone" type="tele" max={10} required/> : null}
            {(contactType === "email") ? <input className="needBorder" name="email" placeholder="Email" type="email" max={25} required/> : null}
            {(contactType === "discord") ? <input className="needBorder" name="discord" placeholder="Discord Username" type="text" max={20} required/> : null}
